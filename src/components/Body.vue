<template>
  ...
  }" @mousedown="onMouseDown" @mousemove="onMouseMove" @mouseup="onDragEnd" @touchstart="onTouchStart"
    @touchmove="onTouchMove" @touchend="onDragEnd">
    <div class="content">
      <Home />
    </div>
    <MessageCenter :isDrag="isDrag" :bottom="bottom" />
    <RandomBgTrigger />
    <Bubble />
    <MusicBar />
    <Header />
